// =============================================================================
// v4_flash_top.sv — DeepSeek V4-Flash FFN Top-Level
// Target: S10 MX Dev Kit (1SM21BHU2F53E1VG)
//
// V4-Flash: 285B params, 27 layers
//   hidden=7168, inter=3072, 384 routed + 1 shared expert, TOP_K=6, FP8
//
// Key difference from V2-Lite: weights are ~4.7× larger.
// Needs HBM2-backed weight storage + systolic array (DSP cascading).
// =============================================================================
...
module v4_flash_top (
    ...
    localparam int NUM_EXPERTS = 385;    // 384 routed + 1 shared
