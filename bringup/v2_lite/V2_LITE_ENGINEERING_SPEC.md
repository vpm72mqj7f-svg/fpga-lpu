# ⚠ DEPRECATED — Superseded by AF_V2LITE_Design_Spec_Rev1.1.md

> **This document is archived.** All content has been uplifted and formalized into:
> **`v2_lite/docs/AF_V2LITE_Design_Spec_Rev1.1.md`**
>
> The new spec is a 15-chapter formal RTL design specification following Arrive Technologies conventions,
> covering: Clock Architecture (PLL, clock tree, CDC, reset FSM), PCIe Endpoint design, DSP IP mandate,
> full register map, configuration sequences, functional timing, resource estimation, and power budget.
